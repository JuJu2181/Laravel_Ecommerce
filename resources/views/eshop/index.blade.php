...
$fourProducts = [];
$threeProducts = [];
for($i=1;$i<count($products);$i++){ if($i < 4){ array_push($threeProducts,$products[$i]); } if($i<5){
    array_push($fourProducts,$products[$i]); } } @endphp <!-- only in index page -->
    <!-- Slider Area -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="single-banner">
                        <img src="{{$product->image == ''?"https://via.placeholder.com/600x370":image_crop($product->image,600,370)}}"
                            alt="#">
                        <div class="content">
                                            ...
                                            <div class="single-product">
                                                        ...
                                                        <div class="product-action-2">
                                                            ...
                                                            <form action="{{route('cart.store')}}" method="post">
                                                                ...
                                                                <a title="Add to cart" href="#"
                                                                    onclick="event.preventDefault();this.closest('form').submit();">Add
                                                                    to cart</a>
                                                            </form>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="product-content">
                                                    <h3 class="text-dark"><a
                                                            href={{ route('product.single',$product->id) }}>{{$product->name}}</a>
                                                    </h3>
                                                    <div class="product-price">
                                                        ...
                                                        <span>
                                                            <a
                                                                href={{ route('category.single',$product->category->id) }}>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner">
                        <img src="{{$products[0]->image==''?'https://via.placeholder.com/600x370':image_crop($products[0]->image,600,370)}}"
                            alt="#">
                        <div class="content">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner">
                        <img src="{{$products[1]->image==''?'https://via.placeholder.com/600x370':image_crop($products[1]->image,600,370)}}"
                            alt="#">
                        <div class="content">
                    ...
                    <div class="owl-carousel popular-slider">
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                <a href="{{route('product.single',$product->id)}}">
                                    <img class="default-img"
                                        src="{{$product->image == ''?'https://via.placeholder.com/550x750':image_crop($product->image,550,750)}}"
                                        alt="#">
                                    <img class="hover-img"
                                        src="{{$product->image == ''?'https://via.placeholder.com/550x750':image_crop($product->image,550,750)}}"
                                        alt="#">
                                ...
                                <div class="button-head">
                                    ...
                                    <div class="product-action-2">
                                        ...
                                        <form action="{{route('cart.store')}}" method="post">
                                            ...
                                            <input type="hidden" name="quantity" value="1">
                                            <a title="Add to cart" href="#"
                                                onclick="event.preventDefault();this.closest('form').submit();">Add to
                                                cart</a>
                                        </form>
                                        @else
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="list-image overlay">
                                    <img src="{{$product->image == ''?'https://via.placeholder.com/115x140':image_crop($product->image,115,140)}}"
                                        alt="#">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 no-padding">
                                <div class="content">
                                    <h4 class="title"><a
                                            href="{{route('product.single',$product->id)}}">{{$product->name}}</a></h4>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 col-12 padding-right">
                        <div class="image">
                            <img src="{{$products[0]->image==''?'https://via.placeholder.com/750x590':image_crop($products[0]->image,750,590)}}"
                                alt="#">
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="shop-single-blog">
                        <img src="{{$post->image==''?'https://via.placeholder.com/370x300':image_crop($post->image,370,300)}}"
                            alt="#">
                        <div class="content">
